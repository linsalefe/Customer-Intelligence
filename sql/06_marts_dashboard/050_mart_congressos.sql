-- Mart: Congressos (produtos >= R$ 90)
DROP VIEW IF EXISTS mart.congressos CASCADE;

CREATE VIEW mart.congressos AS
SELECT
    o.order_id,
    o.customer_id,
...
WHERE o.total_price >= 90
ORDER BY o.sale_date DESC;

-- Stats
SELECT 
    'Congressos' as categoria,
    COUNT(*) as total_vendas,
    COUNT(DISTINCT customer_id) as clientes_unicos,
    ROUND(SUM(valor), 2) as receita_total,
    ROUND(AVG(valor), 2) as ticket_medio
FROM mart.congressos;
